        ...
        <div className="auth-page">
            ...
            <main className="auth-card">
                ...
                <div className="auth-seg">
                    ...
                    <Link to="/register" className="on">Register</Link>
                </div>

                <div style={{ textAlign: 'center', marginBottom: 30 }}>
                    <h1 className="bd-h2" style={{ fontSize: 21 }}>Join the network</h1>
                    <p className="bd-mono" style={{ fontSize: 12, color: 'var(--bd-muted)', marginTop: 8 }}>NEW IDENTITY REGISTRATION</p>
                </div>

                <form onSubmit={handleSubmit}>
                    <div className="auth-fld">
                        <label className="bd-label" htmlFor="name">DISPLAY NAME</label>
                        <input className="bd-input" style={{ marginTop: 9 }} id="name" type="text"
                            placeholder="What should we call you?" value={name}
                    ...
                    <div className="auth-fld">
                        ...
                        <input className="bd-input" style={{ marginTop: 9 }} id="password" type="password"
                            placeholder="••••••••" value={password}
                            onChange={e => setPassword(e.target.value)} required />
                    </div>
                    <button className="bd-btn bd-btn--primary" style={{ width: '100%', marginTop: 8 }} type="submit">Create account</button>
                </form>
                ...
                <div className="auth-ftr">
                    <p className="bd-mono" style={{ fontSize: 12, color: 'var(--bd-muted)' }}>
                        Already tracking? <Link to="/login" style={{ color: 'var(--bd-signal)' }}>Log in</Link>
                    </p>
                </div>
            </main>
